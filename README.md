...
[kaggle link of pre-processed dataset](https://www.kaggle.com/datasets/udaykalyansreenivasa/lsun-bedroom-64x64-10perc)

## Presentation is present in wgan_presentation.pdf

## youtube link: [here](https://youtu.be/-z4BvZeaIM0?si=EkwyXxNYB750j-8z)
...
#### right half of figure 7,8 can be reproduced in wgan_figures-7:right,8:right.ipynb
